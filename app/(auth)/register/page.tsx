                ...
                <div className="flex flex-col justify-center items-center w-[50vw]">
                    ...
                    <div className=" flex justify-end items-center mr-[10%]">
                        <div className="bg-white right-0 space-y-2 rounded-[25px] p-12 w-[500px] h-[652px]">
                            ...
                            <button onClick={() => login()} className={`${isLg ? 'w-[85%] mx-auto': 'w-full'} bg-primary border border-primary text-secondary py-3 px-6 rounded-md  flex items-center justify-center`}>

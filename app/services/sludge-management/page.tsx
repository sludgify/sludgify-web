...
export default function Page() {
    ...
    return (
        <div className="flex min-h-screen w-screen flex-col">
            <Navbar />
            {/* Banner */}
            <div className="bg-[url('/bg-sludge-management.svg')] text-secondary w-full bg-no-repeat bg-cover bg-center h-[300px] md:h-[690px]  md:space-y-3 flex flex-col justify-center">
            ...
            {/* Content */}
            <div className="container flex flex-col-reverse md:flex-row justify-center gap-8 md:gap-2 md:px-10 px-8 mx-auto py-5 md:py-10">
                <RevealOnScroll delay={150} className="md:w-[50%]">
                    <Image src={"/Rectangle 111.svg"} width={549} height={497} alt="Sludgify illustration" className="rounded-xl md:block hidden md:w-[549px]" />
                </RevealOnScroll>
                <RevealOnScroll delay={150}>
                    <Image src={"/Rectangle 111 (1).svg"} width={549} height={497} alt="Sludgify illustration" className="rounded-xl md:hidden block" />
                </RevealOnScroll>
                <RevealOnScroll delay={100} className="md:w-[50%]">
                    <div className="flex flex-col justify-center md:space-y-7 w-full ">
            ...
            <div className="flex flex-col gap-14 items-center justify-center w-screen px-10 md:px-24 py-10 bg-[#FAFAFA]">
                ...
                <div className="md:flex md:flex-row flex flex-col-reverse items-center w-full">
                    ...
                    <RevealOnScroll delay={200} className="md:w-[60%]">
                        <Image src={"/management-dashboard.svg"} alt="management-dashboard" height={504} width={831} className="-mt-8 object-cover hidden md:block  h-[544px]" />

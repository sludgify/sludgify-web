    ...
    return (
        <div className="flex min-h-screen w-screen flex-col">
            ...
            <main className="flex-1 w-full">
                {/* Hero Section*/}
                <div className="bg-[url('/bg-sustainability-report.svg')] text-secondary w-full bg-no-repeat bg-cover bg-center  h-[300px] md:h-[690px] md:space-y-3 flex flex-col justify-center gap-3 p-8 md:p-20">
                ...
                <div className="font-radley w-screen p-6 md:p-12 flex flex-col items-center justify-evenly gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8">
                        {services.map((service, index) => (
                            <div key={index} className="mb-8 break-inside-avoid bg-white p-6 md:w-[592px] inline-block">
                                <Image src={service.url} alt={service.title} width={592} height={400} className="md:mb-4 w-[325px] md:w-[592px] h-[306px] md:h-[400px] rounded-[10px] object-cover" />
                ...
                {/* Client Section */}
                <div className="w-full bg-white px-4 py-12 flex flex-col items-center gap-4 md:gap-8 overflow-x-visible relative">

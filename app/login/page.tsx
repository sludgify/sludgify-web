            ...
            <div className=" flex justify-end items-center mr-[10%] mt-[2%]">
                <div className="bg-white right-0 space-y-2 rounded-[25px] p-12 w-[446px] h-[582px]">
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <button type="submit" className="w-full bg-primary mt-6 text-white py-3 px-6 rounded-xl ">
                            Sign In
                        </button>
                    </form>
                    ...
                    <button className="w-full bg-primary border border-gray-200 text-secondary py-3 px-6 rounded-xl  flex items-center justify-center">

    ...
    return (
        <div className="flex min-h-screen w-full flex-col overflow-hidden">
            ...
            <main className="flex-1 w-full overflow-hidden">
                {/* Hero Section*/}
                <div className="bg-[url('/bg-about.svg')] text-secondary w-full bg-no-repeat bg-cover bg-center h-[300px] md:h-[690px] flex flex-col justify-center ">
                ...
                <div className="bg-[#FAFAFA] font-radley md:p-12 md:flex items-start justify-evenly md:gap-8">
                    {value.map((item, index) => (
                        <RevealOnScroll key={index} delay={index * 150}>
                            <div className="flex flex-col gap-1 md:gap-4 text-balance px-8 md:px-12 text-lg mb-8 md:w-[750px] w-[334px]">
                        ...
                        <div className="columns-1 md:columns-2 gap-3 md:gap-8 max-w-[1248px] mx-auto">
                            {services.map((service, index) => (
                                <RevealOnScroll key={index}  delay={index * 70}>
                                    <div className="mb-4 md:mb-8 break-inside-avoid bg-white md:p-6 w-[325px] md:w-[592px] inline-block">

...
export const BannerFooter = () => {
    return (
        <div className="relative container rounded-2xl bg-[url('/banner.jpg')] bg-no-repeat bg-cover bg-center w-[335px] md:w-[1000px] h-[128px] md:h-[376px] mx-auto px-10 flex flex-col items-start justify-center gap-6 overflow-hidden -mb-20 z-10">
            {/* Overlay gradient */}
